...
class TestProcessMonitor(unittest.TestCase):
    def test_create_monitor(self):
        ...
        monitor = pmet.PyProcessMonitor(["echo", "hello"], 100, 1000)
        self.assertIsNotNone(monitor, "ProcessMonitor should be created")

    def test_invalid_command(self):
        """Test error handling for invalid commands"""
        with self.assertRaises(Exception):
            pmet.PyProcessMonitor([], 100, 1000)  # Empty command should fail
        
        with self.assertRaises(Exception):
            pmet.PyProcessMonitor(["non_existent_command_123456"], 100, 1000)
    ...
    def test_run_short_process(self):
        ...
        monitor = pmet.PyProcessMonitor(cmd, 100, 1000)
...
""")
        ...
        try:
            ...
            monitor = pmet.PyProcessMonitor(["python", str(test_script)], 100, 1000)
